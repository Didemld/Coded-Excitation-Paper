...
p = single(p);
%% Reduce image region
Nx_image= 51;%389;%260;%204;
Ny_image= 51;%200;%315;%630;%366;%240;%238;



%% (Delay model)
downsample_rate =20; %% further reduce image matrix size
...
nx_origin =150+(Nx-150)/2-Nx_image/2;%587;%442;%200;%252;%169;200-
