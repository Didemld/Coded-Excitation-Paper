...
code_length = 3;  %% bit length. could be 3, 5, 7 or even more, in the thesis I chose 5.
...
Ny_image= 1;%200;%315;%630;%366;%240;%238;



%% (Delay model)
downsample_rate =1; %% further reduce image matrix size
...
nx_origin = round(150+(Nx-150)/2-Nx_image/2);%587;%442;%200;%252;%169;200-
ny_origin =round(Ny/2-Ny_image/2) ;%137;%139;
