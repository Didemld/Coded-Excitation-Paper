    ...
    close all
    %
    addpath('C:\Users\lzhu\Documents\kwave')
    initialize_k
    ...
    code_length =5;
    load A_tr_128x5_180&120_140&68_down4.mat
    A_real = real(A_tr);
...
%     n1 = wgn(length(tgc),1,-4)/400;
    ...
    filename1 =['I_e' num2str(tran)];
    save([filename1 '.mat'],'I_matchedfilter');
    filename2 =['I_en' num2str(tran)];
    save([filename2 '.mat'],'I_matchedfilter_noise');
    clear I_matchedfilter I_matchedfilter_noise
end
%%
% initialize_GE
