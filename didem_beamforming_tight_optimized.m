 clc
    ...
    code_length =3;
    load A_tr_96_5x5_code3.mat
    load A_var_96_5x5_code3.mat
    A_real = real(A_tr);
...
for tran = 1 
    didem_initialize_tight
     ...
     load C_96_5x5_code3.mat
%     [c_best,C_best,trinv] = C_random_rounding(C,A_var,A_tr,100);
...
%     n1 = wgn(length(tgc),1,-4)/400;
    ...
    filename1 =['I_2dd' num2str(tran)];
    save([filename1 '.mat'],'I_matchedfilter');
    filename2 =['I_2ddn' num2str(tran)];
