...
for tran = 1:10
    didem_initialize_k
     ...
     load C_256_3x3_code2.mat
    [c_best,C_best,trinv] = C_random_rounding_eig(C,A_var,A_tr,1000);
...
%     n1 = wgn(length(tgc),1,-4)/400;
    ...
    filename1 =['I_eig100_3x3' num2str(tran)];
    save([filename1 '.mat'],'I_matchedfilter');
    filename2 =['I_eig100_3x3_n' num2str(tran)];
